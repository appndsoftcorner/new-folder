...
public class PerformancePlot 
{
    ...
    while((str=br4.readLine())!=null)
     ...
     objDataset.setValue(Float.parseFloat(str1[0][0]), "Precision", "TF-OddsRatio");
     objDataset.setValue(Float.parseFloat(str1[0][1]), "Recall", "TF-OddsRatio");
     objDataset.setValue(Float.parseFloat(str1[0][2]), "F1-Score", "TF-OddsRatio");
     objDataset.setValue(Float.parseFloat(str1[0][3]), "Accuracy", "TF-OddsRatio");
     
     objDataset.setValue(Float.parseFloat(str1[0][0]), "Precision", "NTF-MutualInformation");
     objDataset.setValue(Float.parseFloat(str1[0][1]), "Recall", "NTF-MutualInformation");
     objDataset.setValue(Float.parseFloat(str1[0][2]), "F1-Score", "NTF-MutualInformation");
     objDataset.setValue(Float.parseFloat(str1[0][3]), "Accuracy", "NTF-MutualInformation");
     
     objDataset.setValue(Float.parseFloat(str1[0][0]), "Precision", "NTF-OddsRatio");
     objDataset.setValue(Float.parseFloat(str1[0][1]), "Recall", "NTF-OddsRatio");
     objDataset.setValue(Float.parseFloat(str1[0][2]), "F1-Score", "NTF-OddsRatio");
     objDataset.setValue(Float.parseFloat(str1[0][3]), "Accuracy", "NTF-OddsRatio");
     
     objDataset.setValue(Float.parseFloat(str1[0][0]), "Precision", "Normal TF-IDF");
     objDataset.setValue(Float.parseFloat(str1[0][1]), "Recall", "Normal TF-IDF");
     objDataset.setValue(Float.parseFloat(str1[0][2]), "F1-Score", "Normal TF-IDF");
     objDataset.setValue(Float.parseFloat(str1[0][3]), "Accuracy", "Normal TF-IDF");

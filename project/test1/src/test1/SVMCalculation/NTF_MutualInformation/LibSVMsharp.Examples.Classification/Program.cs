...
namespace LibSVMsharp.Examples.Classification
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            SVMProblem trainingSet = SVMProblemHelper.Load(@"C:\Users\phantom\Desktop\project\calculations\variants\NTF_MutualInformation.txt");
            SVMProblem testSet = SVMProblemHelper.Load(@"C:\Users\phantom\Desktop\project\calculations\variants\NTF_MutualInformation.txt");
            ...
            // Save the model
            SVM.SaveModel(model, @"C:\Users\phantom\Desktop\project\calculations\variants\NTF_MutualInformation_model.txt");
            ...
            System.IO.StreamWriter file = new System.IO.StreamWriter(@"C:\Users\phantom\Desktop\project\calculations\performance values\performance values.txt");

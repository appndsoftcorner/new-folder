...
try
 ...
 {
  fileWords = new Scanner(new File("C:/Users/phantom/Desktop/project/splitted dataset1/" + fileList[k])).useDelimiter("\\Z").next();
 ...
 bw=new BufferedWriter(new FileWriter("C:/Users/phantom/Desktop/project/stopwords removed dataset1/" + fileList[k]));

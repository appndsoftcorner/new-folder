...
public class NormalizedTF1
{
    static int maxValue;
    
    public static void normalizedTF1() throws FileNotFoundException, IOException
    {
        BufferedReader br;
        BufferedWriter bw;
        String[] fileList;
  ...
  if (listOfFiles[k].isFile()) 
  {
   ...
   //System.out.println("File " + listOfFiles[k]);
        ...
        for(int k=0;k<fileList.length;k++)
        {
            int i=0;
            maxValue=0;
            br=new BufferedReader(new FileReader(new File("C:/Users/phantom/Desktop/project/unique stopwords removed dataset2/" + fileList[k])));
            bw=new BufferedWriter(new FileWriter("C:/Users/phantom/Desktop/project/calculations/Normalized TF2/" + fileList[k]));

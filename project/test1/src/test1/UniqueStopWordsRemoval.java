...
public static void uniqueStopWordsRemoval()
{
    BufferedWriter bw;
    String[] fileList;
    int counter=0;
   ...
   try 
   {
    for(int k=0;k<fileList.length;k++)
    {
        ...
        bw=new BufferedWriter((new FileWriter(new File("C:/Users/phantom/Desktop/project/unique stopwords removed dataset1/" + fileList[k]))));

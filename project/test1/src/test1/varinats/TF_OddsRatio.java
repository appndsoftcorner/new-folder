...
{
    public static void tf_OddsRatio() throws FileNotFoundException, IOException
    {
...
for(int j=0;j<fileList.length;j++)
{
    ...
    while((s2=br1.readLine())!=null)
    {
       ...
       bw=new BufferedWriter(new FileWriter(new File("C:/Users/phantom/Desktop/project/calculations/variants/TF1_OddsRadio/" + fileList[j])));
   for(int m=0;m<l;m++)
    {

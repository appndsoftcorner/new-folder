...
namespace LibSVMsharp.Examples.Classification
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            SVMProblem trainingSet = SVMProblemHelper.Load(@"C:\Users\phantom\Desktop\project\calculations\variants\Normal TF_IDF.txt");
            SVMProblem testSet = SVMProblemHelper.Load(@"C:\Users\phantom\Desktop\project\calculations\variants\Normal TF_IDF.txt");
            ...
            parameter.C = 32.0;
            parameter.Gamma = 0.0001220703125;
            ...
            // Save the model
            SVM.SaveModel(model, @"C:\Users\phantom\Desktop\project\calculations\variants\Normal TF_IDF_model.txt");
            ...
            System.IO.StreamWriter file = new System.IO.StreamWriter(@"C:\Users\phantom\Desktop\project\calculations\performance values\performance values4.txt");

...
try
 ...
 {
  fileWords = new Scanner(new File("C:/Users/phantom/Desktop/project/splitted dataset2/final" + k + ".txt")).useDelimiter("\\Z").next();
 ...
 bw=new BufferedWriter(new FileWriter("C:/Users/phantom/Desktop/project/stopwords removed dataset2/stopwordsremovedf " + k + ".txt"));
